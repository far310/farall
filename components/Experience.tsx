          ...
          {experienceDataShown.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <p className="whitespace-pre-line !mt-1 !font-normal text-gray-700 dark:text-white/75">
                  {item.description}
                </p>
              </VerticalTimelineElement>
            </motion.div>
          ...
          {experienceDataShown.map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <h3 className="font-bold capitalize">{item.title}</h3>
                <p className="font-normal !mt-0">{item.location}</p>
                <p className="whitespace-pre-line !mt-1 !font-normal text-gray-700 dark:text-white/75ß" >
                  {item.description}
                </p>
              </div>
            </div>
